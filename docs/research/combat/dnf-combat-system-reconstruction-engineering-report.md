...
| 无敌 | Invincibility / Invincible | 무적(无敌) |
| 反击 / 破招窗口 | Counter | 카운터(反击) |
| 背击 | Rear Attack / Back Attack | 백어택(背击) |
| 抓取免疫 | Grab-immune | 잡기 불가형(抓取免疫) / Grab-immune |
| 空中状态 | Aerial | 공중(空中) |
| 倒地 | Down / Downed | 다운(倒地) |
| 无力化 / 破防槽 | Neutralize | 무력화(无力化) |
| 破裂 | Rupture | Rupture |
| 后撤步强化 | Backstep Upgrade | 백스텝 강화(后撤步强化) |
